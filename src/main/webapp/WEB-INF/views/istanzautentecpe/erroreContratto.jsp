						...
						<div class="art-Post-body">
							<div class="art-Post-inner art-article">
								<h2 class="art-PostHeader">
									<a href="#" title="Permanent Link to this Post">Errore</a>
								</h2>
									<div class="art-PostContent">
										</br>
										<div class='provideCSS-3 art-Block artBlockCorners'	style='padding: 10px; margin: 0px;'>
											</br>
											<div class=errore align="center">
											Errore nella registrazione del contratto!
											</div>
											</br>
										...
										<div align="right">
										<input type="button" value="Nuovo Utente" name="nuovo" class="button artBlockCorners" onclick=document.location.href="<c:url value="/utente/New" />">
										<input type="button" value="Home" name="home" class="button artBlockCorners" onclick=document.location.href="<c:url value="/index" />">
										</div>
