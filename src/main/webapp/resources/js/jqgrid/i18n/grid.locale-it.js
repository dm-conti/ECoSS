(function($){
	$.jgrid =	{
			...
			{	
				...
				matchText:" corrisponde",rulesText:" regole"},
				edit:
				{
				...
				del:
				{
					...
					bSubmit:"Cancella",bCancel:"Annulla"
				},
				nav:
				{
					edittext:" ",
			...
			formatter:
			{
				integer:
				{
					...
					date:
					{
						dayNames:["Dom","Lun","Mar","Mer","Gio","Ven","Sab","Domenica","Lunedì","Martedì","Mercoledì","Giovedì","Venerdì","Sabato"],monthNames:["Gen","Feb","Mar","Apr","Mag","Gui","Lug","Ago","Set","Ott","Nov","Dic","Genneio","Febbraio","Marzo","Aprile","Maggio","Giugno","Luglio","Agosto","Settembre","Ottobre","Movembre","Dicembre"],
						AmPm:["am","pm","AM","PM"],
						S:function(b)
						{
