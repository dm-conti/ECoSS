...
<head>
	...
	jq(function() {
		...
		//Recupero l'oggetto XmlHttpRequest in cui e' contenuta la risposta del server
		...
		//Recupero le riche da inserire in tabella
		...
		jq("#grid").jqGrid({
	      ...
	      //OnSelectRow
		    onSelectRow: function(ids) {
				//var selectedRow = jq('#grid').jqGrid('getGridParam','selrow');
				//alert(selectedRow);
			    var newCaption = jq('#grid').getCell(ids, 'cpeNome');
			    newCaption = dataRows[ids].licenzacpes[0].licCpeNome;
			    if(ids == null) { 
				    ids=0;
