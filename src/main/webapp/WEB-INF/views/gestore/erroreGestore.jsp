							...
							<div class="art-Post-inner art-article">
								<h2 class="art-PostHeader">
									...
									<div class="art-PostContent">
										...
										<div align="right">
										<input type="button" value="Nuovo Gestore" name="nuovo" class="button artBlockCorners" onclick=document.location.href="<c:url value="/gestore/New" />">
