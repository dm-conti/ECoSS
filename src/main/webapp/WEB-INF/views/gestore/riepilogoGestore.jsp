								...
								<div class="art-Post-inner art-article">
									...
									<div class="art-PostContent">
										...
										<div class='provideCSS-3 art-Block artBlockCorners'
											...
											<div class=titleTab align="center">Gestore creato con
												successo!</div>
											</br>
										...
										<div align="right">
											<input type="button" value="Nuovo Gestore" name="nuovo"
												class="button artBlockCorners"
												onclick=document.location.href="<c:url value="/gestore/New" />">
